...
const showMateriel = createAsyncThunk("Materiel/show", async (id, { rejectWithValue }) => {
    try {
        const response = await axios.get(`http://127.0.0.1:8000/api/materiel/${id}`);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const createMateriel = createAsyncThunk("Materiel/create", async (nvMateriel, { rejectWithValue }) => {
    try {
        const response = await axios.post("http://127.0.0.1:8000/api/materiel", nvMateriel);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const updateMateriel = createAsyncThunk("Materiel/update", async (Materiel, { rejectWithValue }) => {
    try {
        const response = await axios.put(`http://127.0.0.1:8000/api/materiel/${Materiel.id}`, Materiel);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
...
const deleteMateriel = createAsyncThunk("Materiel/delete", async (id, { rejectWithValue }) => {
    try {
        const response = await axios.delete(`http://127.0.0.1:8000/api/materiel/${id}`);
        return response.data;
    } catch (error) {
        return rejectWithValue(error.response.data);
    }
